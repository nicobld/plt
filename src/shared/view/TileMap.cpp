        ...
        for (unsigned int i = 0; i < width; ++i){
            ...
            for (unsigned int k = 0; k < 4; k++){
                ...
                switch (k){
                    ...
                    case 1:
                        hex[1].position = sf::Vector2f((i + 1 + j%2 * 0.5) * tileSize.x, (j*0.75 + 0.75) * tileSize.y);
                        hex[2].position = sf::Vector2f((i + 0.5 + j%2 * 0.5) * tileSize.x, (j*0.75 + 1) * tileSize.y);
                    ...
                    case 2:
                        hex[1].position = sf::Vector2f((i + 0.5 + j%2 * 0.5) * tileSize.x, (j*0.75 + 1) * tileSize.y);
                        hex[2].position = sf::Vector2f((i + j%2 * 0.5) * tileSize.x, (j*0.75 + 0.75) * tileSize.y);
                    ...
                    case 3:
                        hex[1].position = sf::Vector2f((i + j%2 * 0.5) * tileSize.x, (j*0.75 + 0.75) * tileSize.y);
                        hex[2].position = sf::Vector2f((i + j%2 * 0.5) * tileSize.x, (j*0.75 + 0.25) * tileSize.y);
