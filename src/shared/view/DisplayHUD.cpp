...
DisplayHUD::DisplayHUD(int WIDTH, int LENGTH, Player player1, Player player2, Player player3, Player player4) {
    ...
    Sprite spritePlayer1Square(player1Square);
    ...
    Sprite spritePlayer2Square(player2Square);
    ...
    Sprite spritePlayer3Square(player3Square);
    ...
    Sprite spritePlayer4Square(player4Square);
